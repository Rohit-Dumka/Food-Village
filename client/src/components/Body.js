            ...
            <div className="body mt-0 overflow-x-hidden">
                ...
                <div className="filter m-4 p-4 md:flex justify-center">
                    ...
                    <div className="flex justify-center">
                        <button className="px-4 py-2 my-4 bg-red-400 hover:bg-red-600 rounded-lg" onClick={() => {
                        ...
                        <button className="px-4 py-2 my-4 mx-8 bg-green-400 hover:bg-green-600 rounded-lg" onClick={() => {
